...
1. **API**: Chiamate HTTP API (come CrocDB)
...
- `id`: Identificatore univoco (es. "mysource", "crocdb")
...
Vedi `sources/crocdb/` per un esempio completo di sorgente API funzionante.
